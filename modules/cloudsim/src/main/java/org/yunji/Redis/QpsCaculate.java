...
public class QpsCaculate {
    ...
    public static int QpsCaculated(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability, int status, int IOnumbers, int readnode){
        int qps = 0;
        switch (status){
            case STANDARDDOUBLE:
                qps=80000;
    ...
    public static int getClusterdoubleQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
    ...
    public static int getClusterenhanceQps(int IOnumbers, int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
        if(checkQps(specification, nodes, connectionpernumber, maxconnection, maxBw, cpuability)){
    ...
    public static int getClusterdisastertoleranceQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
        if(checkQps(specification, nodes, connectionpernumber, maxconnection, maxBw, cpuability)) {
            qps = 100000 * nodes;
        }
    ...
    public static int getClusterSingleQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
        if(checkQps(specification, nodes, connectionpernumber, maxconnection, maxBw, cpuability)) {
            qps = standardqps * nodes;
        }
    ...
    public static int getReadandwriteQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
        if(checkQps(specification, nodes, connectionpernumber, maxconnection, maxBw, cpuability)) {
    ...
    public static int getReadandwriteenhanceQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
        if(checkQps(specification, nodes, connectionpernumber, maxconnection, maxBw, cpuability)) {
            qps = 10 * maxconnection;
        }
    ...
    public static int getClusterreadandwriteQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
        int qps = 0;
        if(checkQps(specification, nodes, connectionpernumber, maxconnection, maxBw, cpuability)) {
            qps = nodes * 200000;
        }
    ...
    public static boolean checkQps(int specification, int nodes, int connectionpernumber, int maxconnection, int maxBw,int cpuability){
